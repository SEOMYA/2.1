...
class Car(models.Model):
    ...
    image = models.ImageField(upload_to='car_images/', blank=True, null=True) # Добавляем поле для изображения
...
class Sale(models.Model):
    ...
    def __str__(self):
        return f"Sale of {self.car} to {self.client} at {self.created_at}"
